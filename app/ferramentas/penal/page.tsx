...
export default function ConsultarPenalPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Utilizamos dados oficiais de 10 legislações brasileiras: Código Penal (CP - 91 artigos incluindo homicídio, feminicídio, receptação, furto qualificado, roubo qualificado, estelionato qualificado, estupro qualificado, extorsão, sequestro, tráfico de pessoas, violação sexual mediante fraude, importunação sexual, assédio sexual), Lei Maria da Penha (2 artigos), Estatuto do Desarmamento (2 artigos), Estatuto da Criança e do Adolescente (ECA - 4 artigos), Lei de Contravenções Penais (LCP - 3 artigos), Lei de Drogas (2 artigos), Código de Trânsito Brasileiro (CTB - 4 artigos), Lei de Crimes Ambientais (5 artigos), Código de Defesa do Consumidor (CDC - 2 artigos) e Lei de Lavagem de Dinheiro (1 artigo). Total de 116 artigos de crimes que podem levar à prisão. Dados fixos armazenados em cache permanente para máxima performance."
    },
    {
      ...
      <div className="container max-w-4xl mx-auto">
        ...
        <div className="mt-12 prose prose-slate max-w-none">
          ...
          <p className="text-slate-600 mb-4">
            ...
            banco de dados oficial, com 116 artigos de crimes que podem levar à prisão (incluindo feminicídio, receptação, furto qualificado, roubo qualificado, estelionato qualificado, estupro qualificado, extorsão, sequestro, tráfico de pessoas, violação sexual mediante fraude, importunação sexual, assédio sexual, Lei Maria da Penha e Estatuto do Desarmamento), garantindo informações precisas e 
          ...
          <ul className="list-disc list-inside text-slate-600 space-y-2 mb-4">
            ...
            <li>116 artigos de crimes que podem levar à prisão, de 10 legislações (CP, Maria da Penha, Desarmamento, LCP, ECA, CTB, CDC e Leis Especiais), incluindo formas qualificadas e agravadas</li>
