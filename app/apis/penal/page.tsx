      ...
      <section className="bg-gradient-to-br from-red-600 to-orange-700 text-white py-20 px-4">
        <div className="container max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-red-100 mb-8 max-w-3xl mx-auto">
            <strong>117 artigos penais brasileiros</strong> de múltiplas legislações com estrutura hierárquica completa, 
              ...
              <CardContent>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    <span>117 artigos de crimes que podem levar à prisão</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-600 mt-0.5" />
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent className="text-slate-600">
                    A API contém <strong>117 artigos penais</strong> de crimes que podem levar à prisão, distribuídos em:
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      <li><strong>Código Penal (CP):</strong> 92 artigos (incluindo homicídio simples, qualificado, feminicídio, culposo, receptação, furto qualificado, roubo qualificado, estelionato qualificado, estupro qualificado, extorsão, sequestro, tráfico de pessoas, violação sexual mediante fraude, importunação sexual, assédio sexual, desacato)</li>
                ...
                <AccordionItem value="item-3">
                  ...
                  <AccordionContent className="text-slate-600">
                    ...
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      <li><strong>Código Penal (CP - Decreto-Lei 2.848/1940):</strong> 92 artigos (incluindo variações qualificadas de furto, roubo, estelionato, estupro, extorsão, sequestro, tráfico de pessoas, violação sexual mediante fraude, importunação sexual, assédio sexual e desacato)</li>
                    ...
                    <strong>Total: 117 artigos de crimes que podem levar à prisão.</strong> Incluindo formas qualificadas e agravadas dos crimes mais comuns. Estamos constantemente expandindo nossa base de dados. Se precisar de outras legislações específicas, <strong>entre em contato</strong> com nossa equipe.
                  </AccordionContent>
                </AccordionItem>
