            ...
            <Link href="/apis/penal">
              <Card className="border-2 border-red-200 hover:border-red-400 hover:shadow-2xl transition-all cursor-pointer group h-full">
                <CardHeader>
                  ...
                  <CardDescription className="text-base">
                    <strong>10 legislações</strong> • Cache permanente • <strong>122 artigos</strong>
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="border-2 border-red-400 bg-white hover:shadow-2xl transition-all duration-300 hover:scale-105 cursor-pointer">
                <Link href="/apis/penal">
                  <CardHeader>
                    ...
                    <CardDescription className="text-base">
                      122 artigos penais de crimes que podem levar à prisão, de 10 legislações brasileiras (CP, Lei Maria da Penha, Estatuto do Desarmamento, ECA, LCP, Lei de Drogas, CTB, CDC e Leis Especiais). Inclui formas qualificadas e agravadas dos crimes mais comuns. Estrutura hierárquica completa. Ideal para autocomplete.
                    </CardDescription>
                    <div className="mt-4 pt-4 border-t border-red-200">
                      <p className="text-sm text-slate-600 mb-2 font-medium">Recursos:</p>
                      <ul className="text-xs text-slate-600 space-y-1">
                        <li>✓ 122 artigos de 10 legislações (incluindo qualificadas)</li>
